...
function DragHandle({ id }: { id: number }) {
  ...
  return (
    ...
    >
      <Icon icon="material-symbols:drag-indicator" className="size-3 text-muted-foreground" />
    ...
    cell: ({ row }) => (
      <Badge variant="outline" className="px-1.5 text-muted-foreground">
        {row.original.status === "Done" ? (
          <Icon icon="material-symbols:check-circle-rounded" className="fill-green-500 dark:fill-green-400" />
        ) : (
      ...
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <div className="flex items-center gap-2">
          <DropdownMenu>
            ...
            >
              <Icon icon="material-symbols:view-column-rounded" data-icon="inline-start" />
              Columns
              <Icon icon="material-symbols:keyboard-arrow-down-rounded" data-icon="inline-end" />
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="w-32">
              {table
                .getAllColumns()
            ...
            <>
              ...
              <div className="grid gap-2">
                <div className="flex gap-2 leading-none font-medium">
                  ...
                  <Icon icon="material-symbols:trending-up-rounded" className="size-4" />
                </div>
